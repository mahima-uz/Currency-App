...
function App() {
  ...
  return (
    // <div className="App p-20 bg-blue-100" >
    //   <div className="result">
    //     {result}
    //   </div>
    //   <div className='inputSection bg-white p-6 rounded-lg shadow-lg'>
    //     <div className='amount'>
    //       <label for="amount">Amount:</label>
    //       <input type="number" value={amount} id="amount" onChange={handleAmountChange} />
    //     </div>
    //     <div>
    //       <label for="fromCurrency">From Currency:</label>
    //       <select id="fromCurrency" value={fromCurrency} onChange={handleFromCurrencyChange} >
    //         <option value='value' selected> choose from currency </option>
    ...
    //         <option value='value' selected> choose to currency </option>
    ...
    //   </div>
    // </div>
    //     <div className="App bg-blue-100 p-6">
    //   <div className="inputSection bg-white rounded-lg shadow-lg p-6">
